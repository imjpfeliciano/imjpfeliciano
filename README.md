...
- **[mc-pixel.app](https://mc-pixel.app)** - Minecraft pixel art generator and community gallery 👾.
...
- **Scholar Social Network** - Technical lead for real-time education platform with groups, events, messaging, and live reactions
- **Recognition & Collaboration Tool** - Led design system development for Slack integration with metrics tracking
- **[omegaUp](https://omegaup.com/)** ([GitHub](https://github.com/omegaup/omegaup)) - Volunteer software engineer (2017-2020) contributing to competitive programming platform used by tens of thousands of students and teachers in Latin America
- **Competitive Programming Mentor** - Trained students achieving medals at Mexican Olympiad in Informatics
...
- Conducted **150+ technical interviews** for frontend, algorithms, and system design
- Led React and algorithms bootcamps at Engineering Congress and externally
- Mentored competitive programming students (2012-2018): **2 silver** and **10 bronze** medals at Mexican Olympiad
- Contestant in ACM-ICPC Mexico (2014) and Mexican Olympiad in Informatics (2010)
